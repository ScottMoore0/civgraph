...
const SOURCE_NAME_ALIASES = new Map([
  ...
  // The 1885-1918 Westminster files abbreviate the county divisions ('Antrim E', 'Cork NE') and
  // prefix the Dublin city divisions; the boundary layer spells them out ('EAST ANTRIM',
  // 'North-East Cork', 'College Green'). Every imported seat resolves to one feature.
  ['pc-1885-ireland', new Map([
    ['EAST ANTRIM', 'Antrim E'],
    ['NORTH ANTRIM', 'Antrim N'],
    ['SOUTH ANTRIM', 'Antrim S'],
    ['NORTH ARMAGH', 'Armagh N'],
    ['SOUTH ARMAGH', 'Armagh S'],
    ['East Cavan', 'Cavan E'],
    ['West Cavan', 'Cavan W'],
    ['East Clare', 'Clare E'],
    ['West Clare', 'Clare W'],
    ...
    ['Mid Cork', 'Cork Mid'],
    ['North Cork', 'Cork N'],
    ['North-East Cork', 'Cork NE'],
    ['South Cork', 'Cork S'],
    ['South-East Cork', 'Cork SE'],
    ['West Cork', 'Cork W'],
    ['East Donegal', 'Donegal E'],
    ['North Donegal', 'Donegal N'],
    ['South Donegal', 'Donegal S'],
    ['West Donegal', 'Donegal W'],
    ['EAST DOWN', 'Down E'],
    ['NORTH DOWN', 'Down N'],
    ['SOUTH DOWN', 'Down S'],
    ['WEST DOWN', 'Down W'],
    ['College Green', 'Dublin College Green'],
    ['North Dublin', 'Dublin County N'],
    ['South Dublin', 'Dublin County S'],
    ['St Patricks', "Dublin St Patrick's"],
    ['St Stephens Green', "Dublin St Stephen's Green"],
    ['NORTH FERMANAGH', 'Fermanagh N'],
    ['SOUTH FERMANAGH', 'Fermanagh S'],
    ['East Galway', 'Galway E'],
    ['North Galway', 'Galway N'],
    ['South Galway', 'Galway S'],
    ['East Kerry', 'Kerry E'],
    ['North Kerry', 'Kerry N'],
    ['South Kerry', 'Kerry S'],
    ['West Kerry', 'Kerry W'],
    ['North Kildare', 'Kildare N'],
    ['South Kildare', 'Kildare S'],
    ['North Kilkenny', 'Kilkenny N'],
    ['South Kilkenny', 'Kilkenny S'],
    ['North Leitrim', 'Leitrim N'],
    ['South Leitrim', 'Leitrim S'],
    ['East Limerick', 'Limerick E'],
    ['West Limerick', 'Limerick W'],
    ['NORTH LONDONDERRY', 'Londonderry N'],
    ['SOUTH LONDONDERRY', 'Londonderry S'],
    ['North Longford', 'Longford N'],
    ['South Longford', 'Longford S'],
    ['North Louth', 'Louth N'],
    ['South Louth', 'Louth S'],
    ['East Mayo', 'Mayo E'],
    ['North Mayo', 'Mayo N'],
    ...
    ['North Meath', 'Meath N'],
    ['South Meath', 'Meath S'],
    ['North Monaghan', 'Monaghan N'],
    ['South Monaghan', 'Monaghan S'],
    ['North Roscommon', 'Roscommon N'],
    ['South Roscommon', 'Roscommon S'],
    ['North Sligo', 'Sligo N'],
    ['South Sligo', 'Sligo S'],
    ['East Tipperary', 'Tipperary E'],
    ['North Tipperary', 'Tipperary N'],
    ['South Tipperary', 'Tipperary S'],
    ['EAST TYRONE', 'Tyrone E'],
    ['NORTH TYRONE', 'Tyrone N'],
    ['SOUTH TYRONE', 'Tyrone S'],
    ['East Waterford', 'Waterford E'],
    ['West Waterford', 'Waterford W'],
    ['North Westmeath', 'Westmeath N'],
    ['South Westmeath', 'Westmeath S'],
    ['North Wexford', 'Wexford N'],
    ['South Wexford', 'Wexford S'],
    ['East Wicklow', 'Wicklow E'],
    ['West Wicklow', 'Wicklow W']
  ])]
]);
